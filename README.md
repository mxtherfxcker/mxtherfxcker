...
```console
$ whoami
C++ Developer | Windows Internals Specialist | Security Researcher
```
...
[![C](https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=black)](https://en.wikipedia.org/wiki/C17_(C_standard_revision))
...
[![VS2026](https://img.shields.io/badge/Visual_Studio-5C2D91?style=flat-square&logo=visualstudio&logoColor=white)](https://learn.microsoft.com/en-us/visualstudio/releases/2026/release-notes)
